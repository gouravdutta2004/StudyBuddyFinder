...
class AnimationController {
  ...
  render() {
    ...
    // Draw background color (navy/dark to blend smoothly, or let CSS background handle it with transparency)
    ctx.fillStyle = 'black'; 
    ...
    ctx.fillStyle = 'rgba(255,255,255,0.7)'; // Dimmed white for stars
  ...
  drawTrail(t1) {
    for (let i = 0; i < this.trailLength; i++) {
        ...
        this.ctx.fillStyle = 'rgba(99,102,241,0.6)'; // A subtle indigo glowing trail
        this.ctx.lineWidth = sw;
...
export function SpiralAnimation() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full z-0 pointer-events-none opacity-40 mix-blend-screen">
